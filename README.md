...
go run ./main.go kubernetes --service-image haseebashfaq/mock_service:v9 --service-max-idle-connections-per-host 64 --client-image tahler/fortio:prometheus ./../example-topologies/10-svc_10-end.yaml ./output.yaml cloud.google.com/gke-nodepool=service-graph-pool cloud.google.com/gke-nodepool=client-pool